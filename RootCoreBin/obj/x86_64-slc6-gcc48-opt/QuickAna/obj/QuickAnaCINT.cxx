...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIuserdIadIabrennandItestareadICxAODTestFrameworkdIRootCoreBindIobjdIx86_64mIslc6mIgcc48mIoptdIQuickAnadIobjdIQuickAnaCINT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ana::Configuration*)
   {
      ...
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::ana::Configuration),0);
      static ::ROOT::TGenericClassInfo 
         instance("ana::Configuration", "QuickAna/Configuration.h", 22,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ana::ELExample*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ana::ELExample", ::ana::ELExample::Class_Version(), "QuickAna/ELExample.h", 30,
...
namespace ROOT {
   ...
   {
      ::ana::QuickAna *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::ana::QuickAna),0);
      static ::ROOT::TGenericClassInfo 
         instance("ana::QuickAna", "QuickAna/QuickAna.h", 30,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ana::ValidationEL*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ana::ValidationEL", ::ana::ValidationEL::Class_Version(), "QuickAna/ValidationEL.h", 32,
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ana::ELExample*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ana::ValidationEL*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/Root",
"/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna",
...
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.05-x86_64-slc6-gcc48-opt/include",
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.05-x86_64-slc6-gcc48-opt/include",
"/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/cmt/",
0
    };
...
namespace ana{struct __attribute__((annotate("$clingAutoload$/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/Root/LinkDef.h")))  Configuration;}
namespace ana{class __attribute__((annotate("$clingAutoload$/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/Root/LinkDef.h")))  ELExample;}
namespace ana{class __attribute__((annotate("$clingAutoload$/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/Root/LinkDef.h")))  QuickAna;}
namespace ana{class __attribute__((annotate("$clingAutoload$/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.1.29/QuickAna/Root/LinkDef.h")))  ValidationEL;}
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("QuickAnaCINT",
        ...
        TriggerDictionaryInitialization_QuickAnaCINT_Impl, {{"template <typename T, typename BASE> class DataVector;", 1},{"namespace DataVector_detail { template <typename B1, typename B2, typename B3> class VirtBases; }", 1}}, classesHeaders);
      isInitialized = true;
    }
  }
