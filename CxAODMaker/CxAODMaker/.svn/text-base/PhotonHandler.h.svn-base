...
private:
  ...
  static bool passVBFLoosePhoton(xAOD::Photon * photon);
  static bool passVBFSignalPhoton(xAOD::Photon * photon);
  ...
  virtual EL::StatusCode setVariables(xAOD::Photon * inPart, xAOD::Photon * outPart, bool isKinVar, bool isWeightVar);
