...
protected:
  ...
  virtual EL::StatusCode decorate(xAOD::Muon * muon); 
  
  virtual EL::StatusCode calibrateCopies(xAOD::MuonContainer * particles, const CP::SystematicSet & sysSet);
   ...
   */
  virtual EL::StatusCode setVariables(xAOD::Muon * inMuon, xAOD::Muon * outMuon, bool isKinVar, bool isWeightVar);
