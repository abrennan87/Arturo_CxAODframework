...
bool VHbb0lepEvtSelection::passSelection(const xAOD::EventInfo* evtinfo,
  ...
  return VHbbEvtSelection<ResultVHbb0lep>::passSelection(evtinfo, met, electrons, photons,  muons, taus, jets);
}
...
bool VHbb0lepEvtSelection::passPreSelection(const xAOD::EventInfo* evtinfo,
  ...
  // one needs to reimplement passSelection here
  // otherwise, don't need to put any code
  return VHbbEvtSelection<ResultVHbb0lep>::passPreSelection(evtinfo, met, electrons, photons,
...
void VHbb0lepEvtSelection::writeEventVariables(const xAOD::EventInfo* eventInfoIn,
